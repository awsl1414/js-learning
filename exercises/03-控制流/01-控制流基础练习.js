...
describe("模块03 - 控制流基础练习", () => {
  ...
  test("任务3: 逻辑运算符短路", () => {
    ...
    expect(getValue(0, 10)).toBe(10);    // 0 是 falsy
  ...
  // ==================== 任务 11-20: break 和 continue ====================

  test("任务11: break 语句", () => {
    function findFirstNegative(arr) {
      for (let i = 0; i < arr.length; i++) {
        if (arr[i] < 0) {
          return arr[i]; // 找到第一个负数就返回
        }
      }
      return null;
    }
